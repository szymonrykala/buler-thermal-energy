<x-layout title="Magazyny Energii - Buler Thermal Energy"
    ...
    <section class="container">
        <article class="row py-5 align-items-center">
            ...
            <div class="d-none d-md-block col-md-4 col-lg-4 col-xl-3">
                <img class="img img-h80" src="{{ asset('images/m-tec-acu-parts.png') }}"
    ...
    <article class="container py-5">
        ...
        <section class="row g-5">
            ...
            <div class="col-12 order-lg-1 col-lg-6">
                <img class="img img-h70 center-block" src="{{ asset('/images/m-tec-img2.png') }}"
            ...
            <div class="col-12 order-lg-12 col-lg-6">
                ...
                <div class="cascade-img">
                    <img class="img" src="{{ asset('/images/bateria-kaskada.png') }}"
    ...
    <section class="container">
        <article class="row gy-3 py-4 vh8">
            ...
            <div class="col-12">
                <x-spec-table id="0" spec-file-name="data/hybrid-inverter-1.json" />
            </div>
        </article>
        ...
        <article class="row gy-3 py-4 vh8">
            ...
            <div class="col-12">
                <x-spec-table id="1" spec-file-name="data/hybrid-inverter-2.json" />
            </div>
        </article>
        ...
        <article class="row gy-3 py-4 vh8">
            ...
            <div class="col-12">
                <x-spec-table id="2" spec-file-name="data/battery-modules.json" />
            </div>
        </article>

    </section>

    <x-business-partners business="batteries" />
