...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sections.hero','data' => ['img' => ''.e(asset('/images/soil-plant-hand.jpg')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['img' => ''.e(asset('/images/soil-plant-hand.jpg')).'']); ?>
        ...
        <div class="row gy-5">
            <div class="col-12">
                <div class="custom-card__container">
                    <a class="custom-card" href="<?php echo e(route('heatpumps.ground.direct-evaporation')); ?>"
...
<?php endif; ?>
                    ...
                    <a class="custom-card" href="<?php echo e(route('heatpumps.ground.glycol')); ?>" aria-roledescription="button"
                        role="button">
                        <span class="custom-card__icon">
...
<?php endif; ?>
                    ...
                    <a class="custom-card" href="<?php echo e(route('heatpumps.ground.water')); ?>" aria-roledescription="button"
                        role="button">
                        <span class="custom-card__icon">
                            <?php if (isset($component)) { $__componentOriginalefa5baff492abd1b4a8b27d5237ca7c2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalefa5baff492abd1b4a8b27d5237ca7c2 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <section class="container vh-5">
        <div class="row py-5">
            <img class="col-12 col-lg-6" src="<?php echo e(asset('images/soil-plant-hand.jpg')); ?>" />
...
<?php endif; ?>
<?php /**PATH /Users/szymeg/Projects/buler_energy/resources/views/heatpumps/main-ground.blade.php ENDPATH**/ ?>